...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 brand-font mb-1">Add New Product</h1>
            <p class="text-muted mb-0">Add a new jewelry product to your store</p>
        </div>
        <div>
...
function addClearAllButton() {
    ...
    if (!existingClearBtn && currentFiles.length > 0) {
        ...
        clearBtn.innerHTML = '<i class="fas fa-trash me-1"></i>Clear All Images';
